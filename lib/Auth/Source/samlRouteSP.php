...
# TODO: cambiar namespace cuando lo mueva a otro módulo específico
namespace SimpleSAML\Module\irismfapanel\Auth\Source;
...
class samlRouteSP extends \SimpleSAML\Module\saml\Auth\Source\SP
{
    ...
    public function __construct($info, $config)
    {
        ...
        $idp = $metadata->getString('idp', '');
        if( $idp != '')
            Logger::debug('[samlRouteSP] idp parameter is set: overriding any mapping');
        else{
        ...
        // Call the parent constructor, as required by the interface
